...
class SwipsTransfer(models.Model):
    ...
    fee_info = models.CharField(max_length=8, choices=fee_info_choice, help_text="close: fee가 보이지 않게함, estimate: 추정, confirm: 확정", initial='close')
    fee_currency = models.CharField(max_length=6, choices=fee_currency_coice, help_text="통화", initial='euro')
